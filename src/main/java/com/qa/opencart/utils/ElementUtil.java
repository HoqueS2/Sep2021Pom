...
public class ElementUtil {
	...
	public WebElement getElement(By locator) {
		...
		if (Boolean.parseBoolean(DriverFactory.highlight)) { // using rapper class convert string to boolean
			jsUtil.flash(element);
		}// if condition true return the element with flash if not return element without flash
		return element;
	}
